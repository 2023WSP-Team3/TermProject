...
<html>
    ...
    <body>
        ...
        <hr style="margin: 0px;">
        <form class="editor-form" name="registration" action="Singup_company" method="post">
            ...
            <div>
                ...
                <h3 style="color: #666666">* Company</h3>
                <input class="info-field" name="company_name" type="text" placeholder="회사명을 입력해주세요."></br>
